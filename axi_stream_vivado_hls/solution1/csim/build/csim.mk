...
HLS_SOURCES = ../../../../test_main.cpp ../../../../main.cpp
...
$(ObjDir)/test_main.o: ../../../../test_main.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../test_main.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/test_main.d
