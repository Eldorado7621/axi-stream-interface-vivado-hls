; ModuleID = '/home/sam/git_workspace/axi-stream-interface-vivado-hls/axi_stream_vivado_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_doGain_ir(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %inStream, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %outStream, i32 %gain) local_unnamed_addr #0 {
entry:
  %inStream_copy.data = alloca i32
  %inStream_copy.keep = alloca i4
  %inStream_copy.strb = alloca i4
  %inStream_copy.user = alloca i2
  %inStream_copy.last = alloca i1
  %inStream_copy.id = alloca i5
  %inStream_copy.dest = alloca i6
  %outStream_copy.data = alloca i32
  %outStream_copy.keep = alloca i4
  %outStream_copy.strb = alloca i4
  %outStream_copy.user = alloca i2
  %outStream_copy.last = alloca i1
  %outStream_copy.id = alloca i5
  %outStream_copy.dest = alloca i6
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %inStream, i32* %inStream_copy.data, i4* %inStream_copy.keep, i4* %inStream_copy.strb, i2* %inStream_copy.user, i1* %inStream_copy.last, i5* %inStream_copy.id, i6* %inStream_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %outStream, i32* %outStream_copy.data, i4* %outStream_copy.keep, i4* %outStream_copy.strb, i2* %outStream_copy.user, i1* %outStream_copy.last, i5* %outStream_copy.id, i6* %outStream_copy.dest)
  ...
  call fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %inStream, i32* %inStream_copy.data, i4* %inStream_copy.keep, i4* %inStream_copy.strb, i2* %inStream_copy.user, i1* %inStream_copy.last, i5* %inStream_copy.id, i6* %inStream_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %outStream, i32* %outStream_copy.data, i4* %outStream_copy.keep, i4* %outStream_copy.strb, i2* %outStream_copy.user, i1* %outStream_copy.last, i5* %outStream_copy.id, i6* %outStream_copy.dest)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"*, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i2* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i5* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i6* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"*, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.0" %_V_data_V1, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.1" %_V_keep_V2, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.2" %_V_strb_V3, i2* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.4" %_V_last_V5, i5* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.5" %_V_id_V6, i6* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.6" %_V_dest_V7) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"*, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i2* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i5* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i6* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"*, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.0" %_V_data_V1, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.1" %_V_keep_V2, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.2" %_V_strb_V3, i2* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.4" %_V_last_V5, i5* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.5" %_V_id_V6, i6* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.6" %_V_dest_V7) unnamed_addr #2 {
entry:
...
entry:
  ...
  %16 = alloca %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %15, i32* %0, i4* %1, i4* %2, i2* %3, i1* %4, i5* %5, i6* %6, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %16, i32* %7, i4* %8, i4* %9, i2* %10, i1* %11, i5* %12, i6* %13)
  call void @doGain_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %15, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %16, i32 %14)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %15, i32* %0, i4* %1, i4* %2, i2* %3, i1* %4, i5* %5, i6* %6, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %16, i32* %7, i4* %8, i4* %9, i2* %10, i1* %11, i5* %12, i6* %13)
  ret void
}

declare void @doGain_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"*, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"*, i32)
